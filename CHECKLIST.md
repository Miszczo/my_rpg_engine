...
- [x] **Testy pytest (15 scenariuszy §2.6)** — `tests/test_*.py` (15 funkcji `test_scenario_*`, reguły z `JUSTIFICATION.md` §4 włączone w scenariusze 7, 8, 11, 12)
- [x] **Docstringi** — wszystkie publiczne klasy i metody w `engine/` (format Google)
- [x] **Type hints** — parametry i zwracane typy w publicznym API `engine/` oraz testach `tests/`
