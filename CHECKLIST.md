...
- [x] **Atrybuty klasy** — `engine/characters.py:Character._next_id`, `engine/items.py:Item._next_id`, `engine/combat.py:Battle._next_id`, `engine/quest.py:Quest._next_id`
...
- [x] **Dodatkowe dundery** — `engine/items.py:Item.__lt__`, `engine/characters.py:Character.__lt__`, `engine/inventory.py:__len__/__iter__/__contains__/__getitem__`, `engine/game_world.py:__getitem__/__contains__/__len__/__iter__`, `engine/combat.py:Battle.__len__`
...
- [x] **Override metody** — `engine/characters.py:Warrior.special_attack` (również `Mage`, `Archer`, `Healer`)
...
- [x] **Duck typing** — `tests/test_characters.py:test_scenario_14_polymorphic_special_attack` (lista `Character`, wspólny interfejs `special_attack()`)
...
- [x] **Klasa abstrakcyjna (ABC)** — `engine/characters.py:Character`, `engine/items.py:Item`, `engine/items.py:Weapon`
- [x] **`@abstractmethod`** — `engine/characters.py:char_class`, `engine/characters.py:special_attack`, `engine/items.py:item_type`, `engine/items.py:use_description`
...
- [x] **Testy pytest (15 scenariuszy §2.6)** — `tests/test_*.py` (15 funkcji `test_scenario_*`)
- [x] **Testy reguł JUSTIFICATION §4** — `tests/test_justification.py` (4 funkcje `test_justification_*`)
- [x] **Docstringi** — wszystkie publiczne klasy i metody w `engine/` (format Google)
- [x] **Type hints** — parametry i zwracane typy w publicznym API `engine/`
